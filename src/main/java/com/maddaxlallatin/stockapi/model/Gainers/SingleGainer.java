...
public class SingleGainer {
    ...
    public SingleGainer(String ticker, String companyName, String price, String change, String changePercent, String volume, String averageVolume, String marketCap, String priceEarningsRatio, String yearChangePercent, String dayChart) {
        this.ticker = ticker;
